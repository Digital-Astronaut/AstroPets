...
public class MobBootsChanceEditor extends PaginatedMenu {

    private AstroMob selectedMob;

    public MobBootsChanceEditor(PlayerMenuUtility playerMenuUtility, AstroMob selectedMob, Menu previousMenu) {
    ...
    public void loopData(Object o) {
        ...
        if (o instanceof Material m) {
            ...
            if (selectedMob.getMobBootsChance().getCurrentMemoryValue() == (index + 1)) {
    ...
    public int getMaxAmountOfDisplayedItems() {
        ...
        return selectedMob.getMobBootsChance().getMaximumValue();
    }

    @Override
    public String getMenuName() {
        return ChatColor.BLUE + "" + ChatColor.BOLD + "Boots Chance";
    }
        ...
        if (e.getRawSlot() < 45) {
            if (e.getCurrentItem().hasItemMeta()) {
                if (e.getCurrentItem().getItemMeta().hasDisplayName()) {
                    ...
                    selectedMob.getMobBootsChance().setCurrentMemoryValue(Integer.parseInt(ChatColor.stripColor(e.getCurrentItem().getItemMeta().getDisplayName())));
                }
                open();
            }
        }
